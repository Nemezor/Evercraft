...
public class GuiPlateMill extends GuiContainer
{
    ...
    private TileEntityPlateMill furnaceInventory;
    private static final ResourceLocation background_texture = new ResourceLocation(ModInformation.GUITEXTUREPATH + "/" + ModInformation.PLATEMILL_GUI + ".png");
    ...
    public GuiPlateMill(InventoryPlayer par1InventoryPlayer, TileEntityPlateMill par2TileEntityFurnace)
    {
        super(new ContainerPlateMill(par1InventoryPlayer, par2TileEntityFurnace));
	...
	private void addRecipes() {
		for (int i = 0; i < Evercraft.getEvercraft().plateMillRecipes.length; i++) {
			this.registerRecipe((ItemStack) Evercraft.getEvercraft().plateMillRecipes[i]);
		}
	}
    ...
    private void getRecipe(boolean mode, int mouseX, int mouseY, int posX1, int posY1, int posX2, int posY2) {
    	if (this.recipeCount > -1) {
	    	if (mode) {
	    		this.drawRecipeForeground(this.recipe_inputs.get(this.recipeCount).getDisplayName(), PlateMillRecipes.plating().getSmeltingResult(this.recipe_inputs.get(this.recipeCount)).getDisplayName(), mouseX, mouseY, posX1, posY1, PlateMillRecipes.plating().getPlateMillRecipeProcessSpeed(this.recipe_inputs.get(this.recipeCount)));
	    	}else{
	    		this.drawRecipeBackground(this.recipe_inputs.get(this.recipeCount), PlateMillRecipes.plating().getSmeltingResult(this.recipe_inputs.get(this.recipeCount)), PlateMillRecipes.plating().getSmeltingResult(this.recipe_inputs.get(this.recipeCount)).stackSize, posX2, posY2);
	    	}
    	}
    }
    ...
    private void drawRecipeForeground(String inputName, String outputName, int mouseX, int mouseY, int x, int y, int processSpeed) {
    	if (this.recipeCount > -1) {
    		...
    		String cost = processSpeed * PowerHandler.PlateMillConsump + " EE";
            this.fontRendererObj.drawString(cost, 214 - this.fontRendererObj.getStringWidth(cost) / 2, this.ySize - 138, 4210752);
    		String consumption = PowerHandler.PlateMillConsump + " EE/tick";
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2)
    {
        ...
        if (this.recipeCount == -1) {
	        ...
	        this.fontRendererObj.drawString("Y-2", 232, this.ySize - 144 + 112, 0x000000);
        }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        if (this.recipeCount == -1) {
	        ...
	        this.drawTexturedModalRect(k + 176, l - 1 + 112, 14, 16, 80, 56);
	        this.drawTexturedModalRect(k + 172, l - 1, 14 + 80, 16, 4, 56);
	        this.drawTexturedModalRect(k + 172, l - 1 + 112, 14 + 80, 16, 4, 56);
	        
	        this.drawTexturedModalRect(k + 194, l + 20, 0, 14, 14, 14);
	
	        this.drawTexturedModalRect(k + 178, l + 4 + 56, 0, 28, 14, 14);
	        this.drawTexturedModalRect(k + 194, l + 4 + 56, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 210, l + 4 + 56, 0, 28, 14, 14);
	        this.drawTexturedModalRect(k + 178, l + 20 + 56, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 194, l + 20 + 56, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 210, l + 20 + 56, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 178, l + 36 + 56, 0, 28, 14, 14);
	        this.drawTexturedModalRect(k + 194, l + 36 + 56, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 210, l + 36 + 56, 0, 28, 14, 14);
	
	        this.drawTexturedModalRect(k + 178, l + 4 + 112, 0, 28, 14, 14);
	        this.drawTexturedModalRect(k + 194, l + 4 + 112, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 210, l + 4 + 112, 0, 28, 14, 14);
	        this.drawTexturedModalRect(k + 178, l + 20 + 112, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 194, l + 20 + 112, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 210, l + 20 + 112, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 178, l + 36 + 112, 0, 28, 14, 14);
	        this.drawTexturedModalRect(k + 194, l + 36 + 112, 0, 42, 14, 14);
	        this.drawTexturedModalRect(k + 210, l + 36 + 112, 0, 28, 14, 14);
        }
        ...
        i1 = this.furnaceInventory.getCookProgressScaled(8);
        this.drawTexturedModalRect(k + 79, l + 35, 176, 0, 24, i1);
        this.drawTexturedModalRect(k + 79, l + 35 + 16 - i1, 176, 16 - i1, 24, i1);
