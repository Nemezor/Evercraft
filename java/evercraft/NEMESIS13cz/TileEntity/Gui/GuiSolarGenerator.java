...
{
    private TileEntitySolarGenerator furnaceInventory;
    private static final ResourceLocation field_110409_t = new ResourceLocation(ModInformation.GUITEXTUREPATH + "/" + ModInformation.SOLARGENERATOR_GUI + ".png");
    public GuiSolarGenerator(InventoryPlayer par1InventoryPlayer, TileEntitySolarGenerator par2TileEntityMachine)
    {
        super(new ContainerSolarGenerator(par1InventoryPlayer, par2TileEntityMachine));
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        if (this.furnaceInventory.isFormed2int == 1) {
        	this.drawTexturedModalRect(k + 149, l + 36, 240, 0, 8, 8);
        }else if (this.furnaceInventory.isFormed2int == 2) {
        	this.drawTexturedModalRect(k + 149, l + 36, 240, 8, 8, 8);
        }
