...
public class ContainerAdvancedCrusher extends Container
{
    private TileEntityAdvancedCrusher furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;
    private int lastUpgradeType = 0;

    public ContainerAdvancedCrusher(InventoryPlayer par1InventoryPlayer, TileEntityAdvancedCrusher par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotAdvancedCrusher(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
        this.addSlotToContainer(new SlotAdvancedCrusher(par1InventoryPlayer.player, par2TileEntityFurnace, 3, 134, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (par2 != 4 && par2 != 1 && par2 != 0)
            {
                ...
                else if (TileEntityAdvancedCrusher.isItemFuel(itemstack1))
                {
                    if (!this.mergeItemStack(itemstack1, 1, 2, false))
                    {
                        return null;
                    }
                }else if (TileEntityAdvancedCrusher.isUpgrade(itemstack1)) {
