...
public class ContainerFurnitureCrafter extends Container
{
...
public ContainerFurnitureCrafter(InventoryPlayer inventoryplayer, World world, int i, int j, int k)
{
...
{
    this.craftResult.setInventorySlotContents(0, FurnitureCrafterRecipes.getInstance().findMatchingRecipe(this.craftMatrix, this.worldObj));
}
...
{
         if(worldObj.getBlock(posX, posY, posZ) != Evercraft_Blocks.blockfurniturecrafter)
         {
                 return false;
         } else
         {
