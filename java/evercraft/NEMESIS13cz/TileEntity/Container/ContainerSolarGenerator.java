...
{
    private TileEntitySolarGenerator furnace;
    private int lastBurnTime = 0;
    private int lastForming = 0;

    public ContainerSolarGenerator(InventoryPlayer par1InventoryPlayer, TileEntitySolarGenerator par2TileEntityFurnace)
    {
        this.furnace = par2TileEntityFurnace;
        this.addSlotToContainer(new Slot(par2TileEntityFurnace, 0, 115, 32));
        int i;
    ...
    public void addCraftingToCrafters(ICrafting par1ICrafting)
    {
        ...
        par1ICrafting.sendProgressBarUpdate(this, 1, this.furnace.isFormed2int);
    }
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.crafters.size(); ++i)
        {
            ...
            {
                icrafting.sendProgressBarUpdate(this, 1, this.furnace.isFormed2int);
            }
        }
