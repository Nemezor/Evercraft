...
import evercraft.NEMESIS13cz.TileEntity.Slot.SlotAdvancedElectrolyzer;
...
public class ContainerAdvancedElectrolyzer extends Container
{
    private TileEntityAdvancedElectrolyzer furnace;
    ...
    public ContainerAdvancedElectrolyzer(InventoryPlayer par1InventoryPlayer, TileEntityAdvancedElectrolyzer par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotAdvancedElectrolyzer(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (AdvancedElectrolyzerRecipes.advancedElectrolyzing().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityAdvancedElectrolyzer.isItemFuel(itemstack1))
                {
                    if (!this.mergeItemStack(itemstack1, 1, 2, false))
                    {
                        return null;
                    }
                }else if (TileEntityAdvancedElectrolyzer.isUpgrade(itemstack1)) {
