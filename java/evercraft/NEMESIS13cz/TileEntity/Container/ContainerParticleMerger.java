...
import evercraft.NEMESIS13cz.TileEntity.Slot.SlotParticleMerger;
...
public class ContainerParticleMerger extends Container
{
    private TileEntityParticleMerger furnace;
    ...
    public ContainerParticleMerger(InventoryPlayer par1InventoryPlayer, TileEntityParticleMerger par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotParticleMerger(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (ParticleMergerRecipes.compacting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityParticleMerger.isItemFuel(itemstack1))
                {
                    if (!this.mergeItemStack(itemstack1, 1, 2, false))
                    {
                        return null;
                    }
                }else if (TileEntityParticleMerger.isUpgrade(itemstack1)) {
