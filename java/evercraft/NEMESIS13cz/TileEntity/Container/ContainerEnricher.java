...
public class ContainerEnricher extends Container
{
    ...
    public ContainerEnricher(InventoryPlayer par1InventoryPlayer, TileEntityEnricher par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotEnricher(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
        this.addSlotToContainer(new SlotEnricher(par1InventoryPlayer.player, par2TileEntityFurnace, 3, 116, 61));
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (EnricherRecipes.enriching().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityEnricher.isItemFuel(itemstack1))
                {
                    if (!this.mergeItemStack(itemstack1, 1, 2, false))
                    {
                        return null;
                    }
                }else if (TileEntityEnricher.isUpgrade(itemstack1)) {
