...
import evercraft.NEMESIS13cz.TileEntity.Slot.SlotCuttingMachine;
...
{
    private TileEntityCuttingMachine furnace;
    ...
    public ContainerCuttingMachine(InventoryPlayer par1InventoryPlayer, TileEntityCuttingMachine par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotCuttingMachine(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (CuttingMachineRecipes.cutting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityCuttingMachine.isItemFuel(itemstack1))
                {
                    if (!this.mergeItemStack(itemstack1, 1, 2, false))
                    {
                        return null;
                    }
                }else if (TileEntityCuttingMachine.isUpgrade(itemstack1)) {
