...
public class ContainerElectrolyzer extends Container
{
    ...
    public ContainerElectrolyzer(InventoryPlayer par1InventoryPlayer, TileEntityElectrolyzer par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotElectrolyzer(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (ElectrolyzerRecipes.electrolyzing().getSmeltingResult(itemstack1) != null)
                {
                ...
                }else if (TileEntityElectrolyzer.isUpgrade(itemstack1)) {
