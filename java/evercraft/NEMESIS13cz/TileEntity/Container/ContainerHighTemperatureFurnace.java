...
import evercraft.NEMESIS13cz.TileEntity.Slot.SlotHighTemperatureFurnace;
...
public class ContainerHighTemperatureFurnace extends Container
{
    private TileEntityHighTemperatureFurnace furnace;
    ...
    public ContainerHighTemperatureFurnace(InventoryPlayer par1InventoryPlayer, TileEntityHighTemperatureFurnace par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotHighTemperatureFurnace(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
    ...
    public void addCraftingToCrafters(ICrafting par1ICrafting)
    {
        ...
        par1ICrafting.sendProgressBarUpdate(this, 5, this.furnace.isFormed2int);
        par1ICrafting.sendProgressBarUpdate(this, 6, this.furnace.S2CsyncProcessSpeed);
        par1ICrafting.sendProgressBarUpdate(this, 8, NumberHelper.boolean2Short(this.furnace.isAdvanced));
    }
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.crafters.size(); ++i)
        {
            ...
            {
                icrafting.sendProgressBarUpdate(this, 5, this.furnace.isFormed2int);
            }
            if (this.lastProcessSpeed != this.furnace.S2CsyncProcessSpeed)
            {
                icrafting.sendProgressBarUpdate(this, 6, this.furnace.S2CsyncProcessSpeed);
            }
            if (this.isAdvanced != this.furnace.isAdvanced) {
            	icrafting.sendProgressBarUpdate(this, 8, NumberHelper.boolean2Short(this.furnace.isAdvanced));
            }
        }
        ...
        this.isAdvanced = this.furnace.isAdvanced;
    }
    ...
    public void updateProgressBar(int par1, int par2)
    {
        ...
        if (par1 == 8) {
        	this.furnace.isAdvanced = NumberHelper.int2boolean(par2);
        }
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (HighPressureFurnaceRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityHighTemperatureFurnace.isItemFuel(itemstack1))
                {
                    if (!this.mergeItemStack(itemstack1, 1, 2, false))
                    {
                        return null;
                    }
                }else if (TileEntityHighTemperatureFurnace.isUpgrade(itemstack1)) {
