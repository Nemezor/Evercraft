...
public class FurnitureCrafterShapedRecipes implements IRecipe
{
    /**
    ...
    public FurnitureCrafterShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public FurnitureCrafterShapedRecipes func_92100_c()
    {
