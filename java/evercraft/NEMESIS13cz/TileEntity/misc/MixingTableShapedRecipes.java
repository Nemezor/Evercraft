...
public class MixingTableShapedRecipes implements IRecipe
{
    /**
    ...
    public MixingTableShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public MixingTableShapedRecipes func_92100_c()
    {
