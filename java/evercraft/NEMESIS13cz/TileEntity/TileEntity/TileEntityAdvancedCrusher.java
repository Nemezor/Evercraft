...
public class TileEntityAdvancedCrusher extends TileEntityMachine implements ISidedInventory
{
    ...
    {
        return this.hasCustomInventoryName() ? this.field_94130_e : "Advanced Crusher";
    }
    ...
    {
        return this.furnaceCookTime * par1 / PowerHandler.AdvCrusherSpeed;
    }
    ...
    {
        return this.power > PowerHandler.AdvCrusherConsump - 1;
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.hasPower() && this.canContinueSmelting() && flagRS && this.processedItem != null)
            {
                ...
                if (this.furnaceCookTime == PowerHandler.AdvCrusherSpeed)
                {
            ...
            {
                flag1 = true;
                BlockAdvancedCrusher.updateFurnaceBlockState(this.isMainTextureOn(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
    ...
    private boolean canContinueSmelting()
    {
        if (this.power <= 0 || this.processedItem == null)
        {
            ...
            {
                ItemStack itemstack = AdvancedCrusherRecipes.advancedCrushing().getSmeltingResult(this.processedItem);
                if (itemstack == null) return false;
                if (this.furnaceItemStacks[2] == null) return true;
                if (this.furnaceItemStacks[3] == null) return true;
                if (!this.furnaceItemStacks[2].isItemEqual(itemstack) && !this.furnaceItemStacks[3].isItemEqual(itemstack)) return false;
    ...
    public boolean isMainTextureOn() {
    	...
    	if (this.isSmelting() || (this.furnaceItemStacks[0] != null && this.hasPower() && AdvancedCrusherRecipes.advancedCrushing().getSmeltingResult(item) != null) && (this.canContinueSmelting() || this.canStartSmelting()) && flagRS) {
    		return true;
    	}else{
    		return false;
    	}
