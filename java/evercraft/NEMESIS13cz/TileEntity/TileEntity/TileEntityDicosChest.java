...
public class TileEntityDicosChest extends TileEntity implements IInventory
{
     ...
     */
    public TileEntityDicosChest adjacentChestZNeg;
    /**
     * Contains the chest tile located adjacent to this one (if any)
     */
    public TileEntityDicosChest adjacentChestXPos;
    /**
     * Contains the chest tile located adjacent to this one (if any)
     */
    public TileEntityDicosChest adjacentChestXNeg;
    /**
     * Contains the chest tile located adjacent to this one (if any)
     */
    public TileEntityDicosChest adjacentChestZPos;
    /**
    ...
    public TileEntityDicosChest()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityDicosChest(int par1)
    {
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : "Diconian Chest";
    }
    ...
    private void func_145978_a(TileEntityDicosChest p_145978_1_, int p_145978_2_)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityDicosChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityDicosChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityDicosChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityDicosChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        return block instanceof BlockDicosChest && ((BlockDicosChest)block).field_149956_a == this.func_145980_j();
    }
    ...
    {
        if (this.getBlockType() instanceof BlockDicosChest)
        {
            --this.numPlayersUsing;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numPlayersUsing);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof BlockDicosChest))
            {
                return 0;
            }

            this.cachedChestType = ((BlockDicosChest)this.getBlockType()).field_149956_a;
        }
