...
public class TileEntityCrusher extends TileEntityMachine implements ISidedInventory
{
    ...
    {
        return this.hasCustomInventoryName() ? this.field_94130_e : "Crusher";
    }
    ...
    {
        return this.furnaceCookTime * par1 / PowerHandler.CrusherSpeed;
    }
    ...
    {
        return this.power > PowerHandler.CrusherConsump - 1;
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.hasPower() && this.canContinueSmelting() && flagRS && this.processedItem != null)
            {
                ...
                if (this.furnaceCookTime == PowerHandler.CrusherSpeed)
                {
            ...
            {
                flag1 = true;
                BlockCrusher.updateFurnaceBlockState(this.isMainTextureOn(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canStartSmelting()
    {
        if (this.power <= 0 || this.furnaceItemStacks[0] == null)
        {
            ...
            {
                ItemStack itemstack = CrusherRecipes.crushing().getSmeltingResult(this.furnaceItemStacks[0]);
            	...
            	int result2 = this.furnaceItemStacks[2].stackSize + itemstack.stackSize;
            	int result3 = this.furnaceItemStacks[3].stackSize + itemstack.stackSize;
                if (this.furnaceItemStacks[2].isItemEqual(itemstack) && result2 <= this.getInventoryStackLimit()) return true;
                if (this.furnaceItemStacks[3].isItemEqual(itemstack) && result3 <= this.getInventoryStackLimit()) return true;
                if (this.furnaceItemStacks[2].isItemEqual(itemstack) && result2 > this.getInventoryStackLimit() && (this.furnaceItemStacks[3] == null || (this.furnaceItemStacks[3].isItemEqual(itemstack) && result3 <= this.getInventoryStackLimit()))) return true; 
                return (!this.furnaceItemStacks[2].isItemEqual(itemstack) && (this.furnaceItemStacks[3] == null || (this.furnaceItemStacks[3].isItemEqual(itemstack) && result3 <= this.getInventoryStackLimit()))); 
            }
    }
    private boolean canContinueSmelting()
    {
        if (this.power <= 0 || this.processedItem == null)
        {
            ...
            {
                ItemStack itemstack = CrusherRecipes.crushing().getSmeltingResult(this.processedItem);
                if (itemstack == null) return false;
                if (this.furnaceItemStacks[2] == null) return true;
                if (this.furnaceItemStacks[3] == null) return true;
                if (!this.furnaceItemStacks[2].isItemEqual(itemstack) && !this.furnaceItemStacks[3].isItemEqual(itemstack)) return false;
    ...
    public void smeltItem()
    {
        if (this.canContinueSmelting())
        {
            ...
            else if (this.furnaceItemStacks[2].isItemEqual(itemstack) && this.furnaceItemStacks[2].stackSize + itemstack.stackSize <= this.getInventoryStackLimit())
            {
                this.furnaceItemStacks[2].stackSize += itemstack.stackSize;
            }
            else if (this.furnaceItemStacks[2].isItemEqual(itemstack) && this.furnaceItemStacks[3] == null && this.furnaceItemStacks[2].stackSize + itemstack.stackSize > this.getInventoryStackLimit())
            {
                this.furnaceItemStacks[3] = itemstack.copy();
            }
            else if (this.furnaceItemStacks[2].isItemEqual(itemstack) && this.furnaceItemStacks[3].isItemEqual(itemstack) && this.furnaceItemStacks[2].stackSize + itemstack.stackSize > this.getInventoryStackLimit() && this.furnaceItemStacks[3].stackSize + itemstack.stackSize <= this.getInventoryStackLimit())
            {
                this.furnaceItemStacks[3].stackSize += itemstack.stackSize;
            }
            else if (this.furnaceItemStacks[2].isItemEqual(itemstack) && (!this.furnaceItemStacks[3].isItemEqual(itemstack) || this.furnaceItemStacks[3] != null) && this.furnaceItemStacks[2].stackSize + itemstack.stackSize <= this.getInventoryStackLimit())
            {
                this.furnaceItemStacks[2].stackSize += itemstack.stackSize;
            }
            else if (!this.furnaceItemStacks[2].isItemEqual(itemstack) && this.furnaceItemStacks[3] == null)
            {
                this.furnaceItemStacks[3] = itemstack.copy();
            }
            else if (!this.furnaceItemStacks[2].isItemEqual(itemstack) && this.furnaceItemStacks[3].isItemEqual(itemstack) && this.furnaceItemStacks[3].stackSize + itemstack.stackSize <= this.getInventoryStackLimit())
            {
                this.furnaceItemStacks[3].stackSize += itemstack.stackSize;
            }
        }
    ...
    public boolean isMainTextureOn() {
    	...
    	if (this.isSmelting() || (this.furnaceItemStacks[0] != null && this.hasPower() && CrusherRecipes.crushing().getSmeltingResult(item) != null) && (this.canContinueSmelting() || this.canStartSmelting()) && flagRS) {
    		return true;
    	}else{
    		return false;
    	}
    ...
    {
        return par1 == 2 ? false : par1 == 3 ? false : (par1 == 1 ? isItemFuel(par2ItemStack) : true);
    }
