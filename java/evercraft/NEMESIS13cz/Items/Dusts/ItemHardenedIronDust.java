...
public class ItemHardenedIronDust extends Item {
public ItemHardenedIronDust() {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.HARDENED_IRON_DUST);
}
}