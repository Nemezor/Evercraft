...
public class ItemSuperalloyDust extends Item {
public ItemSuperalloyDust() {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.SUPERALLOY_DUST);
}
}