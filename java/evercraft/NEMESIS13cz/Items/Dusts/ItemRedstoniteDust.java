...
public class ItemRedstoniteDust extends Item {
public ItemRedstoniteDust() {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.REDSTONITE_DUST);
}
}