...
public class ItemHardenedLapisDust extends Item {
public ItemHardenedLapisDust() {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.HARDENED_LAPIS_DUST);
}
}