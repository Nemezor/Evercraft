...
public class ItemHardenedIronPowder extends Item {
public ItemHardenedIronPowder() {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.HARDENED_IRON_POWDER);
}
}