...
public class ItemElectrumPowder extends Item {
public ItemElectrumPowder() {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.ELECTRUM_POWDER);
}
}