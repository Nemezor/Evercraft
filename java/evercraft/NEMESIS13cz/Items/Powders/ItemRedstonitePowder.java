...
public class ItemRedstonitePowder extends Item {
public ItemRedstonitePowder() {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.REDSTONITE_POWDER);
}
}