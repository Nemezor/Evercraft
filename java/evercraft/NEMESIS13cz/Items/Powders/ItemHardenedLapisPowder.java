...
public class ItemHardenedLapisPowder extends Item {
public ItemHardenedLapisPowder() {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.HARDENED_LAPIS_POWDER);
}
}