...
public class  ItemCopperBoots extends ItemArmor {
	...
	public ItemCopperBoots(ItemArmor.ArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
	...
	{
	    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.COPPER_BOOTS);
	}
