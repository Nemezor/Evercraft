...
public class WorldGenMinable_NuggetOre extends WorldGenerator
{
    ...
    public WorldGenMinable_NuggetOre(Block par1, int metadata, int par2, boolean grassCheck)
    {
        minableBlockId = par1;
        numberOfBlocks = par2;
            ...
            for (int l1 = j; l1 <= i1; l1++)
            {
                ...
                for (int i2 = k; i2 <= j1; i2++)
                {
                    ...
                    for (int j2 = l; j2 <= k1; j2++)
                    {
                        ...
                        if (grass) {
                        	doGenerate = par1World.getBlock(l1, i2 - 1, j2) == Blocks.grass;
                        }else{
                        	doGenerate = par1World.getBlock(l1, i2, j2) == Blocks.gravel && (par1World.getBlock(l1, i2 + 1, j2) == Blocks.water || par1World.getBlock(l1, i2 + 1, j2) == Evercraft_Blocks.blocknuggetOre);
                        }
                        
                        if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && doGenerate) {
                           	par1World.setBlock(l1, i2, j2, minableBlockId);
                           	par1World.setBlockMetadataWithNotify(l1, i2, j2, minableBlockMetadata, 0);
                        }
                    }
                }
            }
