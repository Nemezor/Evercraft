package evercraft.NEMESIS13cz.misc.materialMinables;
...
public class WorldGenMinable_Emeralds extends WorldGenerator
{
    ...
    public WorldGenMinable_Emeralds(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, Blocks.stone);
    }

    public WorldGenMinable_Emeralds(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public WorldGenMinable_Emeralds(Block block, int meta, int number, Block target)
    {
                    ...
                    for (int l2 = j1; l2 <= i2; ++l2)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 < 1.0D)
                        {
                            for (int i3 = k1; i3 <= j2; ++i3)
                            {
                                ...
                                if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && par1World.getBlock(k2, l2, i3).isReplaceableOreGen(par1World, k2, l2, i3, field_150518_c) && (par1World.getBiomeGenForCoords(k2, i3).isEqualTo(BiomeGenBase.extremeHills) || par1World.getBiomeGenForCoords(k2, i3).isEqualTo(BiomeGenBase.extremeHillsPlus) || par1World.getBiomeGenForCoords(k2, i3).isEqualTo(BiomeGenBase.extremeHillsEdge)))
                                {
