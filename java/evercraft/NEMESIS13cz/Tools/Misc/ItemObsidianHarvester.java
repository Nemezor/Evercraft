...
public class ItemObsidianHarvester extends Item {
public ItemObsidianHarvester() {
setCreativeTab(ECTabs.tabECTools);
this.maxStackSize = 1;
this.setMaxDamage(Evercraft_Config_Base.obsidianharvesterUSES);
}
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
        		...
        		ItemStack DROP = new ItemStack(Blocks.obsidian,1);
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.OBSIDIAN_HARVESTER);
}
}