...
public class ItemCopperSword extends ItemSword
{
    ...
    public ItemCopperSword(Item.ToolMaterial par2EnumToolMaterial)
    {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.COPPER_SWORD);
}
}
