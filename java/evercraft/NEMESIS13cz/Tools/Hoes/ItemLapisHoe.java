...
{
    public ItemLapisHoe(Item.ToolMaterial par2EnumToolMaterial)
    {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.LAPIS_HOE);
}
}
