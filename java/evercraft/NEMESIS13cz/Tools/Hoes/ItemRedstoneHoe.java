...
{
    public ItemRedstoneHoe(Item.ToolMaterial par2EnumToolMaterial)
    {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.REDSTONE_HOE);
}
}
