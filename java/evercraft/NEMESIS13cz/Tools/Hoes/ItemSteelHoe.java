...
{
    public ItemSteelHoe(Item.ToolMaterial par2EnumToolMaterial)
    {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.STEEL_HOE);
}
}
