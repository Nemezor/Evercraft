...
{
    public ItemBronzeHoe(Item.ToolMaterial par2EnumToolMaterial)
    {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.BRONZE_HOE);
}
}
