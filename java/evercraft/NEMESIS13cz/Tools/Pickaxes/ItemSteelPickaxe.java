...
public class ItemSteelPickaxe extends ItemPickaxe
{
    ...
    public ItemSteelPickaxe(Item.ToolMaterial par2ECEnumToolMaterial)
    {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.STEEL_PICKAXE);
}
}
