...
public class ItemBronzePickaxe extends ItemPickaxe
{
    ...
    public ItemBronzePickaxe(Item.ToolMaterial par2ECEnumToolMaterial)
    {
...
{
    this.itemIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.BRONZE_PICKAXE);
}
}
