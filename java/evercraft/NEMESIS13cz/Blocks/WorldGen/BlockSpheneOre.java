...
public class BlockSpheneOre extends Block {



public BlockSpheneOre(String texture) {
super(Material.rock);
...
{
return Evercraft_Items.sphenelump;
}
...
public int getExpDrop(World par1World, int par5, int par7)
{
    if (this.getItemDropped(par5, par1World.rand, par7) != Item.getItemFromBlock(this))
    {
        ...
        j1 = MathHelper.getRandomIntegerInRange(par1World.rand, 1, 7);
        return j1;
    }
...
{
    this.blockIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.SPHENE_ORE);
}
}