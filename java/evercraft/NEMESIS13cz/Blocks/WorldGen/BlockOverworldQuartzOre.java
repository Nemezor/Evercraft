...
public class BlockOverworldQuartzOre extends Block {



public BlockOverworldQuartzOre(String texture) {
super(Material.iron);
...
public int damageDropped(int par1)
{
	...
	{
	    this.blockIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.OVERWORLD_QUARTZ_ORE);
	}
}