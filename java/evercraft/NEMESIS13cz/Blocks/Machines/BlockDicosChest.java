...
public class BlockDicosChest extends BlockContainer
{
    private final Random field_149955_b = new Random();
    public final int field_149956_a;
    private static final String __OBFID = "CL_00000214";

    public BlockDicosChest(int p_i45397_1_)
    {
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityDicosChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        TileEntityDicosChest tileentitychest = (TileEntityDicosChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);
    ...
    {
    	TileEntityDicosChest tileentitychest = (TileEntityDicosChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        else
        {
            ...
            if (iinventory != null)
            {
            	if (p_149727_5_.getGameProfile().getId().toString().equals("51f2ad3c-6cc8-40ea-aa2b-f25970316921") || p_149727_5_.getGameProfile().getId().toString().equals("e452e012-2c82-456d-853b-3ac8e6b581f5")) {
                    p_149727_5_.displayGUIChest(iinventory);
            	}else{
            		p_149727_5_.addChatComponentMessage(new ChatComponentText(EnumChatFormatting.RED + "This belongs to Dico. You could have been redstonized!"));
            	}
            }
    ...
    {
        Object object = (TileEntityDicosChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_);
        ...
        else
        {
            ...
            {
                object = new InventoryLargeChest("Diconian Double Chest", (TileEntityDicosChest)p_149951_1_.getTileEntity(p_149951_2_ - 1, p_149951_3_, p_149951_4_), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_ + 1, p_149951_3_, p_149951_4_) == this)
            {
                object = new InventoryLargeChest("Diconian Double Chest", (IInventory)object, (TileEntityDicosChest)p_149951_1_.getTileEntity(p_149951_2_ + 1, p_149951_3_, p_149951_4_));
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ - 1) == this)
            {
                object = new InventoryLargeChest("Diconian Double Chest", (TileEntityDicosChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ - 1), (IInventory)object);
            }

            if (p_149951_1_.getBlock(p_149951_2_, p_149951_3_, p_149951_4_ + 1) == this)
            {
                object = new InventoryLargeChest("Diconian Double Chest", (IInventory)object, (TileEntityDicosChest)p_149951_1_.getTileEntity(p_149951_2_, p_149951_3_, p_149951_4_ + 1));
            }
    ...
    {
    	TileEntityDicosChest tileentitychest = new TileEntityDicosChest();
    ...
    public int isProvidingWeakPower(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_)
    {
        ...
        {
            int i1 = ((TileEntityDicosChest)p_149709_1_.getTileEntity(p_149709_2_, p_149709_3_, p_149709_4_)).numPlayersUsing;
