...
public class BlockCentrifuge extends BlockPowerNetwork
{
    /**
    ...
    @SideOnly(Side.CLIENT)
    private IIcon furnaceIconSide;

    public BlockCentrifuge(boolean par2)
    {
        super(Material.iron);
        this.isActive = par2;
    }
    ...
    {
        return par1 == 1 ? this.furnaceIconTop : (par1 == 0 ? this.furnaceIconTop : (par1 != par2 ? this.furnaceIconSide : this.furnaceIconFront));
    }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? (ModInformation.TEXTUREPATH + ":" + ModInformation.CENTRIFUGE_FRONT_ON) : (ModInformation.TEXTUREPATH + ":" + ModInformation.CENTRIFUGE_FRONT_OFF));
        this.furnaceIconSide = par1IconRegister.registerIcon(this.isActive ? (ModInformation.TEXTUREPATH + ":" + ModInformation.CENTRIFUGE_SIDE_ON) : (ModInformation.TEXTUREPATH + ":" + ModInformation.CENTRIFUGE_SIDE_OFF));
    ...
    {    	
        ...
        {
            TileEntityCentrifuge tileentityfurnace = (TileEntityCentrifuge)par1World.getTileEntity(par2, par3, par4);
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, Evercraft_Blocks.blockcentrifugeOn);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, Evercraft_Blocks.blockcentrifugeOff);
        }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityCentrifuge)par1World.getTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
        }
    }
    ...
    {
        return Item.getItemFromBlock(Evercraft_Blocks.blockcentrifugeOff);
    }
}
