...
public class BlockCrusher extends BlockPowerNetwork
{
    /**
    ...
    public BlockCrusher(boolean par2)
    {
        super(Material.iron);
        this.isActive = par2;
    }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? (ModInformation.TEXTUREPATH + ":" + ModInformation.CRUSHER_FRONT_ON) : (ModInformation.TEXTUREPATH + ":" + ModInformation.CRUSHER_FRONT_OFF));
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, Evercraft_Blocks.blockcrusherOn);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, Evercraft_Blocks.blockcrusherOff);
        }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityCrusher)par1World.getTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void breakBlock(World world, int par2, int par3, int par4, Block block, int par6)
    {
        ...
        {
        	TileEntityCrusher tileentityfurnace = (TileEntityCrusher)world.getTileEntity(par2, par3, par4);
    ...
    {
        return Item.getItemFromBlock(Evercraft_Blocks.blockcrusherOff);
    }
}
