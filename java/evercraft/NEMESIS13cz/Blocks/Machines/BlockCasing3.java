...
public class BlockCasing3 extends Block {



public BlockCasing3(String texture) {
super(Material.iron);
...
{
    this.blockIcon = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + ModInformation.MACHINE_CASING_3);
}
}