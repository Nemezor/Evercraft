...
public class BlockOreFactory extends BlockPowerNetwork
{
    /**
    ...
    public BlockOreFactory(boolean par2)
    {
        super(Material.iron);
        this.isActive = par2;
    }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? (ModInformation.TEXTUREPATH + ":" + ModInformation.ORE_FACTORY_FRONT_ON) : (ModInformation.TEXTUREPATH + ":" + ModInformation.ORE_FACTORY_FRONT_OFF));
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityOreFactory tileentityfurnace = (TileEntityOreFactory)par1World.getTileEntity(par2, par3, par4);
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, Evercraft_Blocks.blockorefactoryOn);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, Evercraft_Blocks.blockorefactoryOff);
        }
    ...
    {
        return new TileEntityOreFactory();
    }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityOreFactory)par1World.getTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
        }
    }
    ...
    {
        return Item.getItemFromBlock(Evercraft_Blocks.blockorefactoryOff);
    }
}
