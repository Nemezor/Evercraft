...
public class BlockEC2Bricks extends Block
{
    /////////////////////////////////
private static int BlockMetaCount = 16; //
    /////////////////////////////////
	
       public BlockEC2Bricks(Material m)
       {
             super(m);
       }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
             ...
             {
                    icons[i] = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + "blockEC2bricks" + i);
             }
    }
