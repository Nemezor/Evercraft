...
public class BlockECColoredBricks2 extends Block
{
    /////////////////////////////////
private static int BlockMetaCount = 16; //
    /////////////////////////////////
	
       public BlockECColoredBricks2(Material m)
       {
             super(m);
       }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
             ...
             {
                    icons[i] = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + "blockcoloredbrickssmooth" + i);
             }
    }
