...
public class BlockECColoredBricks extends Block
{
    /////////////////////////////////
private static int BlockMetaCount = 16; //
    /////////////////////////////////
	
       public BlockECColoredBricks(Material m)
       {
             super(m);
       }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
             ...
             {
                    icons[i] = par1IconRegister.registerIcon(ModInformation.TEXTUREPATH + ":" + "blockcoloredbricks" + i);
             }
    }
