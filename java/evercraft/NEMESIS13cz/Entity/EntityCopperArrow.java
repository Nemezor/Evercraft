...
public class EntityCopperArrow extends Entity implements IProjectile
{
    ...
    public EntityCopperArrow(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public static DamageSource causeArrowDamage(EntityCopperArrow par0EntityArrow, Entity par1Entity)
    {
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Evercraft_Items.copperarrow, 1)))
            {
                flag = false;
            }
