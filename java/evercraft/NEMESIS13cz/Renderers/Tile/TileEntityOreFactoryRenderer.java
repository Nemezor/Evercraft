...
public class TileEntityOreFactoryRenderer implements ISimpleBlockRenderingHandler {
	
	public static final TileEntityOreFactoryRenderer INSTANCE = new TileEntityOreFactoryRenderer();

	@Override
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		int meta=3;
		if(block == Evercraft_Blocks.blockorefactoryOn) meta=1;
