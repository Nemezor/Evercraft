...
public class TileEntityCuttingMachineRenderer implements ISimpleBlockRenderingHandler {
	
	public static final TileEntityCuttingMachineRenderer INSTANCE = new TileEntityCuttingMachineRenderer();

	@Override
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		int meta=3;
		if(block == Evercraft_Blocks.blockcuttingmachineOn) meta=1;
