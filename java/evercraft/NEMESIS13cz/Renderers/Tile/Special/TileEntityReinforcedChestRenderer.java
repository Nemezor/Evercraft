...
public class TileEntityReinforcedChestRenderer extends TileEntitySpecialRenderer
{
    ...
    private static final ResourceLocation field_110632_d = new ResourceLocation(ModInformation.MODELTEXTUREPATH + "/" + ModInformation.LARGE_REINFORCEDCHEST + ".png");

    public static final ResourceLocation field_110631_g = new ResourceLocation(ModInformation.MODELTEXTUREPATH + "/" + ModInformation.SMALL_REINFORCEDCHEST + ".png");
    ...
    public TileEntityReinforcedChestRenderer()
    {
     ...
     */
    public void renderTileEntityChestAt(TileEntityReinforcedChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof BlockReinforcedChest && i == 0)
            {
                try
                {
                    ((BlockReinforcedChest)block).func_149954_e(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
    ...
    {
        this.renderTileEntityChestAt((TileEntityReinforcedChest)par1TileEntity, par2, par4, par6, par8);
    }
}
