...
public class TileEntityCapacitorStorage implements ISimpleBlockRenderingHandler {
	
	public static final TileEntityCapacitorStorage INSTANCE = new TileEntityCapacitorStorage();
