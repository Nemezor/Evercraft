...
public class TileEntityAdvancedCrusherRenderer implements ISimpleBlockRenderingHandler {
	
	public static final TileEntityAdvancedCrusherRenderer INSTANCE = new TileEntityAdvancedCrusherRenderer();

	@Override
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		int meta=3;
		if(block == Evercraft_Blocks.blockadvancedcrusherOn) meta=1;
