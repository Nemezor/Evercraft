...
public class TileEntityEnricherRenderer implements ISimpleBlockRenderingHandler {
	
	public static final TileEntityEnricherRenderer INSTANCE = new TileEntityEnricherRenderer();

	@Override
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		int meta=3;
		if(block == Evercraft_Blocks.blockEnricherOn) meta=1;
