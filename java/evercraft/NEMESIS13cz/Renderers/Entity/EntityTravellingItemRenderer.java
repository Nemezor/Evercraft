package evercraft.NEMESIS13cz.Renderers.Entity;
...
public class EntityTravellingItemRenderer extends Render
{
    ...
    public EntityTravellingItemRenderer()
    {
     ...
     */
    public void doRender(EntityTravellingItem p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ItemStack itemstack = p_76986_1_.getItemstack();
     ...
     */
    protected ResourceLocation getEntityTexture(EntityTravellingItem p_110775_1_)
    {
        return this.renderManager.renderEngine.getResourceLocation(p_110775_1_.getItemstack().getItemSpriteNumber());
    }

    /**
     * Renders a dropped item
     */
    private void renderDroppedItem(EntityTravellingItem p_77020_1_, IIcon p_77020_2_, int p_77020_3_, float p_77020_4_, float p_77020_5_, float p_77020_6_, float p_77020_7_)
    {
        this.renderDroppedItem(p_77020_1_, p_77020_2_, p_77020_3_, p_77020_4_, p_77020_5_, p_77020_6_, p_77020_7_, 0);
    }

    private void renderDroppedItem(EntityTravellingItem p_77020_1_, IIcon p_77020_2_, int p_77020_3_, float p_77020_4_, float p_77020_5_, float p_77020_6_, float p_77020_7_, int pass)
    {
        ...
        if (p_77020_2_ == null)
        {
            ...
            ResourceLocation resourcelocation = texturemanager.getResourceLocation(p_77020_1_.getItemstack().getItemSpriteNumber());
        ...
        if (this.renderManager.options.fancyGraphics)
        {
            ...
            float f9 = 0.0625F;
            f10 = 0.021875F;
            ItemStack itemstack = p_77020_1_.getItemstack();
    ...
    {
        return this.getEntityTexture((EntityTravellingItem)p_110775_1_);
    }
    ...
    {
        this.doRender((EntityTravellingItem)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    ...
    private static EntityTravellingItemRenderer instance;
    /**
     ...
     */
    public static EntityTravellingItemRenderer getInstance()
    {
        if (instance == null) instance = new EntityTravellingItemRenderer();
        return instance;
    }
    /*==================================== FORGE END =============================================*/
}